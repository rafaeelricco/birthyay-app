const LinesSVG: React.FC<React.SVGProps<SVGSVGElement>> = (props: React.SVGProps<SVGSVGElement>) => {
   return (
      <svg viewBox="0 0 1920 1441" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
         <path
            opacity={0.24}
